...
namespace SheetMaker
{
    internal class App : IExternalApplication
    {
        public Result OnStartup(UIControlledApplication app)
        {
            ...
            ButtonDataClass myButtonData = new ButtonDataClass("btnSheetMaker", "Sheet Maker", Command.GetMethod(), Properties.Resources.Green_32, Properties.Resources.Green_16, "This is a tooltip");
